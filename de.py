...
class DECameraBase(ccdcamera.CCDCamera):
    ...
    def __init__(self):
        ...
        self.dimension = self.getDictProp('Sensor Size')
...
class DD(DECameraBase):
    ...
    def finalizeSetup(self):
        ...
        if self.name == 'DE64c':
            ...
            # nmovies = math.ceil(nframes / nfractionation)
            # ms = self.getExposureTime()
    ...
    def custom_setup(self):
        if self.name == 'DE64':
            ...
            # self.setProperty('Electron Counting - Dose Fractionation Number of Frames', '35')
            ...
            self.setProperty('Autosave Final Image', 'Discard')
            self.setSaveRawFrames(False)
            # Check names
            self.setECThreshold(self.name)
            self.setECDoseFractionationNumberFrames(self.name)
#           self.setECDoseFractionationNumberFrames('35')
#           self.setECThreshold('9')
